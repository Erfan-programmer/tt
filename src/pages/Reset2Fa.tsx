      ...
      <div className="sm:mb-[4rem]">
        <div className="formlayout-bg-mobile-Titan-recover p-4 Account Recovery flex flex-col items-start justify-end px-[1rem] sm:hidden bg-black/60">
          ...
          <motion.span
            ...
            >
            If you have lost access to your Titan account information, don&apos;t worry — our support team is fully committed to helping you through the recovery process. If you wish to reset your 2FA code, please be aware that this procedure involves a fee, requires patience, and you must verify your account ownership to the company.
          </motion.span>
        </div>
        <div className="px-4">
          <div className="hidden sm:block">
            ...
            >
             If you have lost access to your Titan account information, don&apos;t worry — our support team is fully committed to helping you through the recovery process. <br /> If you wish to reset your 2FA code, please be aware that this procedure involves a fee, requires patience, and you must verify your account ownership to the company.
