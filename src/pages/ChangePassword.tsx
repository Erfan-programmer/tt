...
export default function ChangePassword() {
  ...
  const handleBlur = (field: "currentPassword" | "newPassword" | "newPasswordConfirmation") => {
...
//   };
  ...
  const validateForm = (): boolean => {
    if (!currentPassword.trim() || !newPassword.trim() || !newPasswordConfirmation.trim()) {
      return false;
    }
    ...
    if (errors.currentPassword || errors.newPassword || errors.newPasswordConfirmation) {
      return false;
    }
            ...
            <form className="sm:mt-[5rem] sm:space-y-6">
              ...
              >
                <CustomInput
                  ...
                  type="password"
                  minLength={6}
                  hasError={touched.newPasswordConfirmation && !!errors.newPasswordConfirmation}
              ...
              <div className="mt-10">
                <motion.button
                  ...
                  className={`submit-register text-white w-[80%] ${
                    !validateForm() || isLoading ? "opacity-50" : "cursor-pointer"
                  }`}
