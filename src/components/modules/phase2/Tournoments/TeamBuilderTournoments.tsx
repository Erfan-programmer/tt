        ...
        >
          ...
          <div className="team-tournoment-description mt-2 w-[100%] sm:w-[80%]">
            <span className="text-gray-700 dark:text-white text-sm">
              A special challenge for those determined to build a powerful team
              or organization. As you progress through building your team and
              reach Bronze, Silver, and Gold ranks, you’ll earn increasing
