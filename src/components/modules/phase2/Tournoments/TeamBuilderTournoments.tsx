...
  const showStartButton = status === "can_start" || status === "not_started";
  const buttonText = showStartButton ? "Start Challenge" : "View Tournament";
...
              </span>
            </div>
            {/* Conditional rendering for TimerTournoment and TournomentStepLevel */}
            <Image
