...
export default function PaymentTitan({ paymentProp }: PaymentTitanProps) {
  ...
  const [payment] = useState<PaymentData | null>(
    paymentProp || (paymentEncoded ? decodeData(paymentEncoded) : null)
  );
  ...
  if (!payment) return <div>No payment data provided</div>;
        ...
        <div className="w-[100%] lg:w-[80%] flex flex-wrap gap-x-2 sm:gap-x-4 justify-center items-center mx-auto border-standard bg-[#f9f9fe] dark:bg-[#0f163a] p-2 pt-[1rem] mt-[2rem] rounded-lg">
          ...
          <div className="text-[var(--dark-color)] dark:text-white flex-1 min-w-[200px]">
            <div className="flex flex-col gap-1 mb-2">
              ...
              <span className="font-semibold text-base">
                Deposit Amount:{" "}
                <span className="font-mono">${payment.usd_amount}</span>
              </span>
              <span className="font-semibold text-base">
                Billing Currency:{" "}
