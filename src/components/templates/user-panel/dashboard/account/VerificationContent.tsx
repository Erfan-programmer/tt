      ...
      {headerData?.verified && (
        ...
        >
          <span className="text-white">
            Your account is already verified. You will be redirected to your
            dashboard.
          </span>
        </TitanNotification>
      )}
          ...
          {verifyResult && verifyResult !== "" && (
            <>
              ...
              {verifyResult === "success" ? (
                ...
                >
                  <span className="text-white">
                    Your documents have been successfully submitted! Our team
                    will review them, and you will be notified once the
                    verification is complete. Please note that the review
                    process may take up to 10 business days, depending on your
                    nationality.
                  </span>
                </TitanNotification>
              ) : verifyResult === "failed" ? (
