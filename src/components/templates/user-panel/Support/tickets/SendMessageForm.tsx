...
export default function SendMessageForm({
  ...
  const validate = () => {
    ...
    if (!formData.message || formData.message === "<p><br></p>") errs.message = "Message is required";
...
/>
      ...
      <form className="p-2 sm:px-[1rem]" onSubmit={handleSubmit}>
        ...
        {errors.department_id && (
          <span className="text-[.8rem] text-red-500">{errors.department_id}</span>
        )}
        ...
        <div className="my-4">
          ...
          />
          {errors.subject && (
            <span className="text-[.8rem] text-red-500">{errors.subject}</span>
          )}
        </div>
        ...
        <div className={`my-4 my-quill-editor `}>
          ...
          />
          {errors.message && (
            <span className="text-[.8rem] text-red-500">{errors.message}</span>
          )}
        </div>
