...
Automated Trading Systems Your capital will be entrusted to Titan's fully automated trading systems for a period of two years under the “Investor” contract.
...
${user?.plan?.user_percentage}% of profit goes to the investor
${user?.plan?.withdrawal_fee_percentage}% is retained by the company
...
Capital Protection Priority In case of a ${user?.plan?.withdrawal_fee_percentage}% loss across total invested capital, all trading operations will be halted and ${user?.plan?.user_percentage}% of remaining funds will be returned to investors.
Account Type Is Non-Changeable Switching from the “Investor” account to other types (Marketer or Contract-Free) is not allowed.
...
You will gain access to the full potential and advanced services of Titan’s investment ecosystem.
...
Thank you for trusting Titan Investments. We wish you a journey filled with success and prosperity. ♥️`,
    },
    marketer: {
      description: `
    Dear ${user?.first_name} ${user?.last_name} Marketer, Thank you for choosing to join Titan Investments as a valued marketer. Please read the following terms carefully. By proceeding with your payment and registration, you confirm your full understanding and acceptance of all conditions stated below.
...
Entry Fee and Benefits The entry payment is a one-time fee granting you full access to Titan's marketing infrastructure. This fee is not considered an investment, does not yield any returns, and will not be refunded after the account period ends. It strictly covers your onboarding and participation in Titan’s marketing program.
...
We welcome you to Titan Investments and look forward to seeing your success and growth within our global marketing network. ♥️`,
    },
  };
  ...
  const activationInfo =
    AccountActivationData[type as keyof typeof AccountActivationData];
  return (
    <>
      <TitanNotice
